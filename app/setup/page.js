              ...
              <div className="grid grid-cols-4 gap-3 px-4 max-w-[280px] mx-auto">
                {Array(12).fill(0).map((_, index) => (
                  <input
                    ...
                    placeholder="0"
                    className="w-full h-12 text-center font-mono text-base rounded-md bg-white/70 border border-red-950/20 focus:border-red-950/60 focus:ring-1 focus:ring-red-950/30 focus:outline-none shadow-sm"
                    disabled={isLoading}
                  />
                ))}
              </div>
