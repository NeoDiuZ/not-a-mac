  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-4">
        <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-md w-full border border-black/10 text-center">
          ...
          <div className="space-y-4">
            <Link 
              href="/"
              className="flex items-center justify-center space-x-2 bg-black text-white py-3 px-6 rounded-lg hover:bg-black/80 transition-colors duration-300 w-full"
            >
            ...
            <Link
              href="/setup"
              className="flex items-center justify-center space-x-2 bg-white/50 text-black py-3 px-6 rounded-lg border border-black/20 hover:bg-white/70 transition-colors duration-300 w-full"
            >
